...
function Filter(props) {
    ...
    const { filteredTickers, setFilteredTickers } = props;
    ...
    return (
        <section className="filterContent ">
            <form onSubmit={filterContent}>
                <div className="filterContent__about">
